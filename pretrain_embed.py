"""
Embedding Pretraining v3 - Two-Phase Approach

Phase 1: Train embeddings to encode types
  - Pokemon → Types (multi-label)
  - Move → Type (single label)
  - Train until 95%+ accuracy on both

Phase 2: Freeze type knowledge, train effectiveness
  - Pokemon + Move → Effectiveness class
  - Embeddings already know types, just need to combine them

This guarantees embeddings encode type information before learning effectiveness.

Usage:
    python pretrain_embeddings_v3.py                    # Run both phases
    python pretrain_embeddings_v3.py --verify           # Verify embeddings
    python pretrain_embeddings_v3.py --phase1-only      # Only train types
"""
...
class EmbeddingPretrainerV3(nn.Module):
    ...
    def __init__(self, config_path: str):
        ...
        # === Phase 2 Head: Effectiveness ===
        # Takes pokemon + move embeddings only
